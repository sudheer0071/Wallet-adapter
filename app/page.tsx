            ...
            <div className="  pt-10">
              ...
              <div className=" mt-10">
                ...
                <div className="flex justify-center mt-10 pb-14">
                  <Tabs defaultValue="account" className=" max-w-5xl w-full px-3 md:px-8 lg:px-10 flex justify-center flex-col">
                    ...
                    {warn && <div className={`${walletConnect ? ' hidden' : ''} text-center absolute md:font-semibold lg:font-semibold text-white z-[10] left-[10%] md:left-[20%] lg:left-[38%] mt-10 text-3xl`}> 
